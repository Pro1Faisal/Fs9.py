#!/usr/bin/env python
# Fs9 is a Web Applications Security Scanner
# By Pro1Faisal  - twitter.com/Pro1Faisal
# First demo conducted 12Apr-2014 @OWASP Chapter Riyadh
...
print ga.green+'''
	 FS9 
        ...
        ##############################################################
        #| "Fs9" Web Applications Security Scanner              #
        #|  By PRO1Faisal - @Zigoo0                              #
        #|  This Version Supports Remote Code/Command Execution, XSS #
        #|  And SQL Injection.                                       #
	#|  Thanks @moli57_, @kulla32 @fin.32,         #
